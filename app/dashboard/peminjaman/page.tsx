            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className={`border-b ${theme === 'dark' ? 'border-white/5' : 'border-slate-100'}`}>
                  ...
                  <th className="pb-6 px-8 md:px-12 text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">Status</th>
                </tr>
              </thead>
                  ...
                  <tr key={loan.id} className="group hover:bg-white/5 transition-all duration-300">
                    <td className="py-8 px-8 md:px-12">
                      <div className="flex items-center gap-4">
                        <div className={`w-10 h-10 rounded-xl flex items-center justify-center font-bold ${theme === 'dark' ? 'bg-white/5 text-slate-400' : 'bg-slate-100 text-slate-400'
                          }`}>
                          <Wrench size={18} />
                        </div>
